...
<div id="scrollable_content_wrapper_<?php print $options['items']; ?>" class="wrapper">
  <div class="navi <?php print $classes; ?>"></div>

  <a class="prev scrollable_content_prev <?php print $classes; ?>"></a>

  <div id="scrollable_content_<?php print $options['items']; ?>" class="scrollable_content <?php print $direction; ?> <?php print $classes; ?>">
